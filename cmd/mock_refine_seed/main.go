					...
					Fragments: []*refinerv1.RagFragment{
						{
							...
							Content: strings.Join([]string{
								"2026-04-17T13:19:10Z INFO dashboard HTTP server listening on http://127.0.0.1:18080",
				...
				},
				{
					...
					Fragments: []*refinerv1.RagFragment{
						...
						},
						{
							...
							Content: "service | listen | container | state\ncontext-refiner | 15051/18080 | refiner | ok\notel-collector | 14318 | collector | timeout\ntempo | 13200 | tempo | receiving partial data\nredis | 16379 | redis | backlog high",
						},
					},
				},
				{
